...
class LanguageHandler:
    ...
    async def process_query(self, query: str, target_language: str = None) -> dict:
        """
    ...
    async def process_response(self, response: str, source_language: str = "es", 
                             target_language: str = None, context: dict = None) -> dict:
        """
    ...
    def get_language_stats(self) -> dict:
        ...
        return {
            "detector": {
                "method": "automatic" if hasattr(self.detector, 'LANGDETECT_AVAILABLE') and self.detector.LANGDETECT_AVAILABLE else "rule_based",
...
# Instancia global del manejador de lenguaje
